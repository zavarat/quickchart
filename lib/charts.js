...
function renderChartJs(width, height, backgroundColor, devicePixelRatio, untrustedChart) {
  ...
  if (typeof untrustedChart === 'string' && !process.env.FAST_UNSAFE_RENDER) {
    ...
    return doRenderChartJs(width, height, backgroundColor, devicePixelRatio, untrustedChart);
  }
}

async function doRenderChartJs(width, height, backgroundColor, devicePixelRatio, untrustedChart) {
  let chart;
