...
const RENDER_PROCESS_COUNT = parseInt(process.env.RENDER_PROCESS_COUNT, 10) || os.cpus().length * 2;
...
function getProcess(reqId, resolve, reject) {
  if (processCount < RENDER_PROCESS_COUNT) {
    ...
    proc.setMaxListeners(RENDER_PROCESS_COUNT + 2);
